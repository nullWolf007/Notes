...
## 线程
* **线程调用run和start方法的区别**
> 线程对象调用run方法不开启线程，仅仅是对象调用方法。线程对象调用start方法开启线程，并让jvm调用run方法再开启的线程中执行
* **实现线程的两种方法**
> 继承extends Thread，对象调用start方法
> 实现implements Runnable接口，创建Thread类对象，构造方法传递Runnable接口实现类，再调用Thread对象的start方法
* **线程的状态**
<img src="https://github.com/nullWolf007/Java/blob/master/Image/%E7%BA%BF%E7%A8%8B%E7%8A%B6%E6%80%81%E5%9B%BE.JPG"/>
